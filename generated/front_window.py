...
################################################################################
## Form generated from reading UI file 'TimeshseetUIRMkqsA.ui'
##
...
class Ui_DialogTimeSheet(object):
    def setupUi(self, DialogTimeSheet):
        ...
        self.lineEdit_file_path_input = QLineEdit(DialogTimeSheet)
        self.lineEdit_file_path_input.setObjectName(u"lineEdit_file_path_input")

        self.gridLayout.addWidget(self.lineEdit_file_path_input, 3, 1, 1, 1)
